...
const Footer = () => {
  return (
    <div className='container bg-indigo-500 mt-5 font-bold footer'>
     <div className="grid grid-cols-4 ">
      <div className="ms-3 mt-5">
        <span  ><i class="fa-solid fa-truck-fast text-white"></i></span><a className='fw-bolder fs-4'style={{textDecoration:'none', color:'white'}}><>BookStore E-Commerce Website</></a>
    ...
    <p className='text-white'>Currently v5.3.2</p>
      ...
      <a className='fw-bolder'style={{textDecoration:'none', color:'white'}} href="">Tailwind Css</a><br />
